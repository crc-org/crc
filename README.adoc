...
With your approval, CodeReady Containers collect usage data and send it pseudonymized to Red Hat servers to help improve our products and services. Read our https://developers.redhat.com/article/tool-data-collection[privacy statement] to learn more about it. To know the specific data points being collected, see xref:usage-data.adoc#data-table[usage-data.adoc].

The first time a version of CodeReady Containers is run, you will be asked to opt-in to Red Hat's telemetry collection program:
