...
func (_m *Client) GetConfig(configs []string) (client.GetConfigResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func([]string) (client.GetConfigResult, error)); ok {
		return rf(configs)
	}
...
// IsPullSecretDefined provides a mock function with no fields
func (_m *Client) IsPullSecretDefined() (bool, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for IsPullSecretDefined")
	}
...
func (_m *Client) SetConfig(configs client.SetConfigRequest) (client.SetOrUnsetConfigResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(client.SetConfigRequest) (client.SetOrUnsetConfigResult, error)); ok {
		return rf(configs)
	}
...
func (_m *Client) SetPullSecret(data string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for SetPullSecret")
	}
...
func (_m *Client) Start(config client.StartConfig) (client.StartResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(client.StartConfig) (client.StartResult, error)); ok {
		return rf(config)
	}
...
func (_m *Client) Status() (client.ClusterStatusResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (client.ClusterStatusResult, error)); ok {
		return rf()
	}
...
func (_m *Client) UnsetConfig(configs []string) (client.SetOrUnsetConfigResult, error) {
	...
	var r0 client.SetOrUnsetConfigResult
	var r1 error
	if rf, ok := ret.Get(0).(func([]string) (client.SetOrUnsetConfigResult, error)); ok {
		return rf(configs)
	}
...
func (_m *Client) Version() (client.VersionResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (client.VersionResult, error)); ok {
		return rf()
	}
...
// WebconsoleURL provides a mock function with no fields
func (_m *Client) WebconsoleURL() (*client.ConsoleResult, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for WebconsoleURL")
	}

	var r0 *client.ConsoleResult
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ConsoleResult, error)); ok {
		return rf()
	}
