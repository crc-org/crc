...
func init() {
	...
	flagSet.IntP(crcConfig.CPUs, "c", preset.MinCPUs(), "Number of CPU cores to allocate to the instance")
	flagSet.IntP(crcConfig.Memory, "m", preset.MinMemoryMiB(), "MiB of memory to allocate to the instance")
