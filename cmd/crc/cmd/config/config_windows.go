...
var (
	...
	SkipCheckHyperVServiceRunning = cfg.AddSetting("skip-check-hyperv-service-running", nil, []cfg.ValidationFnType{cfg.ValidateBool}, []cfg.SetFn{cfg.SuccessfullyApplied})
	WarnCheckHyperVServiceRunning = cfg.AddSetting("warn-check-hyperv-service-running", nil, []cfg.ValidationFnType{cfg.ValidateBool}, []cfg.SetFn{cfg.SuccessfullyApplied})
)
