...
var (
	...
	SkipCheckKvmDriver          = createSetting("skip-check-kvm-driver", nil, []validationFnType{validations.ValidateBool})
	WarnCheckKvmDriver          = createSetting("warn-check-kvm-driver", nil, []validationFnType{validations.ValidateBool})
